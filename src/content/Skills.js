Skills = cc.Layer.extend({
    ...
    ctor: function (in_controller) {
        ...
        this._contentText = new cc.Sprite(resDyn.skillsText);
    ...
    show:function(){
     ...
     //   this._arrowRight.setPosition(this._contentBGImage.width/2+ 5,0);
      ...
      //  this._arrowRight.stopAllActions();
        ...
        //    this._arrowLeft.runAction(new cc.fadeIn(2));
        //    this._arrowRight.runAction(new cc.fadeIn(2));
        ...
        switch (type) {
            case ccui.Widget.TOUCH_BEGAN:
                ...
                if (sender == this._arrowRight ) {
                    ...
                    if(this._currentGalleryIndex >= this._maxPageCount)
                    {
                    ...
                    {
                        this._currentGalleryIndex=this._maxPageCount-1;
                    }
